...
.PHONY: migrate run run-ollama cli models-list models-pull local-smoke content-ingest jarvis-bootstrap jarvis-up jarvis-cli jarvis-status jarvis-logs jarvis-down jarvis-reset test test-unit test-contract test-integration test-golden test-architecture test-e2e test-evaluation test-db-up test-db-down
...
test-evaluation:
	JARVIS_RUN_EVALUATION_TESTS=1 $(PYTEST) --run-evaluation -m evaluation tests/evaluation
