...
class EventType(StrEnum):
    ...
    LOOP_SELECTION_STARTED = "request.loop_selection.started"
    LOOP_SELECTION_COMPLETED = "request.loop_selection.completed"
    LOOP_SELECTION_FAILED = "request.loop_selection.failed"
